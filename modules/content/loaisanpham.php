<?php 
	$id = $_GET['id'];
	$resuft = mysqli_query($conn,"SELECT * FROM sanpham WHERE idLSP = '$id'");
	$count = mysqli_num_rows($resuft);
	$total_records = $count;
...
<div id="maincontent" class="col-xs-12 col-sm-8 col-md-12">
	<div  class="text-left">
				...
				<div class='ct-boxmain row m0' id="loaisp">
					<?php 
				        $runs = mysqli_query($conn,"SELECT * FROM sanpham where idLSP = '$id' Limit $start , $limit");
